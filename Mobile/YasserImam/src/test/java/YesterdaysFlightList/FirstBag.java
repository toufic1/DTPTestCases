...
public class FirstBag extends BaseTest {

// 1. Tap on First Bag option from the home screen.
// 2. Check if BAG KPI page is open
// 3. Tap on yesterday's count for All /individual terminals
// 4. Check if Flight List Screen is open w.r.t. selected time
    @Test(priority = 1)
    public void checkFirstBagPage() throws InterruptedException {
        main.clickFirstBag();
        Thread.sleep(5000);
...
@Test(dependsOnMethods = "checkFirstBagPage")
